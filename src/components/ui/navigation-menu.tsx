...
const navigationMenuTriggerStyle = cva(
  'group inline-flex h-9 w-max items-center justify-center rounded-md bg-white px-4 py-2 text-sm font-medium hover:bg-neutral-100 hover:text-main focus:bg-neutral-100 focus:text-main disabled:pointer-events-none disabled:opacity-50 data-[state=open]:hover:bg-neutral-100 data-[state=open]:text-main data-[state=open]:focus:bg-neutral-100 data-[state=open]:bg-neutral-100/50 ring-neutral-950/10 dark:ring-neutral-950/20 dark:outline-ring/40 outline-ring/50 transition-[color,box-shadow] focus-visible:ring-4 focus-visible:outline-1 dark:bg-neutral-950 dark:hover:bg-neutral-800 dark:hover:text-neutral-50 dark:focus:bg-neutral-800 dark:focus:text-neutral-50 dark:data-[state=open]:hover:bg-neutral-800 dark:data-[state=open]:text-neutral-50 dark:data-[state=open]:focus:bg-neutral-800 dark:data-[state=open]:bg-neutral-800/50 dark:ring-neutral-300/10 dark:dark:ring-neutral-300/20'
)
...
function NavigationMenuTrigger({
  ...
  return (
    <NavigationMenuPrimitive.Trigger
      ...
      className={cn(navigationMenuTriggerStyle(), 'group bg-transparent  text-sm hover:text-main ', className)}
      {...props}
    >
      {children}
      {''}
...
function NavigationMenuLink({ className, ...props }: ComponentProps<typeof NavigationMenuPrimitive.Link>) {
  return (
    <NavigationMenuPrimitive.Link
      ...
      className={cn(
        "relative inline-flex flex-col gap-1 p-2 text-md text-tmain transition-[color,box-shadow] duration-300   border-b-2 border-transparent   focus-visible:ring-4 focus-visible:outline-1   [&_svg:not([class*='size-'])]:size-4   [&_svg:not([class*='text-'])]:text-neutral-500   dark:[&_svg:not([class*='text-'])]:text-neutral-400",

        "after:content-[''] after:absolute after:left-0 after:bottom-0 after:h-[2px] after:w-full after:scale-x-0 after:bg-main after:origin-left after:transition-transform after:duration-300 hover:after:scale-x-100",
