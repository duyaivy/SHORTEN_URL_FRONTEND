...
export default function ControlUrls({ onCheckAll, extraUrls, onDeleteUrls }: ControlUrlsProps) {
  ...
  return (
    <div className='flex flex-col md:flex-row w-full md:items-center justify-between items-start'>
      <div className='flex gap-2 md:gap-4 justify-start flex-1 items-center'>
        ...
        {countChecked > 0 && (
          <ConfirmDeleteDialog requiredText={t('require_text_all', { count: countChecked })} onConfirm={onDeleteUrls}>
